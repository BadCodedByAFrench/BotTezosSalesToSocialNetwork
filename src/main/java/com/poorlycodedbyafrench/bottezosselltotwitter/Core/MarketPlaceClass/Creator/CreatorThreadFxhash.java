...
import com.poorlycodedbyafrench.bottezosselltotwitter.Core.MarketPlaceClass.Caller.CallFxhash;
 ...
 * @author david
 */
public class CreatorThreadFxhash implements CreatorThreadMarketPlaceInterface{

    @Override
    public CallMarketPlaceInterface callMarketPlace(BotModeEnum mode, List<String> contracts, LastRefresh lastrefresh) {
        return new CallFxhash(mode, contracts, lastrefresh);
    }
