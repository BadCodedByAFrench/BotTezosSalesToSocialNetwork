...
import com.poorlycodedbyafrench.bottezosselltotwitter.Core.MarketPlaceClass.Caller.CallTeia;
 ...
 * @author david
 */
public class CreatorThreadTeia implements CreatorThreadMarketPlaceInterface {

    @Override
    public CallMarketPlaceInterface callMarketPlace(BotModeEnum mode, List<String> contracts, LastRefresh lastrefresh) {
        return new CallTeia(mode, contracts, lastrefresh);
    }
